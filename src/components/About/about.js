      ...
      <div id='about' className='mb-8 scroll-mt-12'>
        ...
        <div className='flex flex-col-reverse md:justify-between md:flex-row' >
          <div className='md:w-7/12'>
            ...
            <p className='pb-4'>It's been a long journey since that first course and I've loved every step of it! I am currently working as a Software Development Engineer at <a href='https://aws.amazon.com/bedrock/' target="_blank" rel='noreferrer' className='highlight transition duration-200 border-b border-transparent hover:border-pink'>AWS Bedrock</a> where I am focusing on building systems to automate capacity management.</p>
            <p className='pb-4'>In my free time, I love to read, sew, crochet, paint murals on my apartment walls, design printed circuit boards, expand my Pokémon figurine collection, and learn about cool new technologies!</p>
          ...
          <div className='m-4 md:ml-4 w-1/2 self-center h-fit shadow transform hover:scale-[1.03] transition-all rounded-full w-full md:w-1/3 2xl:w-1/4 bg-gradient-to-r from-[#D1B5DF] to-[#C77890] p-2'>
            <div className='bg-black p-4 rounded-full'>
              <StaticImage
                alt="A headshot of a woman with dark brown hair and a light brown sweater smiling into the camera."
